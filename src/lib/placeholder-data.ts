...
export const subjects: Subject[] = [
  { id: 'SUB001', code: 'INF111', name: 'INTRODUCCION A LA INFORMATICA', level: 1, credits: 4 },
  { id: 'SUB002', code: 'MAT101', name: 'CALCULO I', level: 1, credits: 5 },
  { id: 'SUB003', code: 'FIS100', name: 'FISICA I', level: 1, credits: 5 },
  { id: 'SUB004', code: 'INF121', name: 'PROGRAMACION I', level: 2, credits: 4 },
  { id: 'SUB005', code: 'MAT102', name: 'CALCULO II', level: 2, credits: 5 },
  { id: 'SUB006', code: 'FIS102', name: 'FISICA II', level: 2, credits: 5 },
  { id: 'SUB007', code: 'INF211', name: 'ESTRUCTURA DE DATOS I', level: 3, credits: 5 },
  { id: 'SUB008', code: 'INF221', name: 'PROGRAMACION II', level: 4, credits: 4 },
  { id: 'SUB009', code: 'INF312', name: 'SISTEMAS OPERATIVOS I', level: 5, credits: 4 },
  { id: 'SUB010', code: 'INF322', name: 'BASE DE DATOS I', level: 6, credits: 5 },
  { id: 'SUB011', code: 'INF413', name: 'REDES I', level: 7, credits: 4 },
  { id: 'SUB012', code: 'INF423', name: 'TALLER DE BASE DE DATOS', level: 8, credits: 5 },
